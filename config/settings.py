...
INSTALLED_APPS = [
    ...
    'apps.non_infrastructure.apps.NonInfrastructureConfig',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.system.navigation.account_navigation',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='gabaldon_db'),
        'USER': config('DB_USER', default='postgres'),
        'PASSWORD': config('DB_PASSWORD', default='Capstoners123'),
...
LOGIN_OTP_ENABLED = config('LOGIN_OTP_ENABLED', default=False, cast=bool)
