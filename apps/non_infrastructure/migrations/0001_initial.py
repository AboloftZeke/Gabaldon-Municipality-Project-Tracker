# Generated initial migration for non_infrastructure app
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('social_services', 'Social Services'), ('community_development', 'Community Development'), ('livelihood', 'Livelihood Programs'), ('governance', 'Governance'), ('education_support', 'Education Support'), ('health_support', 'Health Support'), ('cultural', 'Cultural & Heritage'), ('tourism', 'Tourism Development'), ('disaster_management', 'Disaster Management'), ('other', 'Other')], max_length=50)),
                ...
                ('publication_status', models.CharField(choices=[('draft', 'Draft'), ('pending_review', 'Pending Review'), ('published', 'Published'), ('needs_revision', 'Needs Revision'), ('rejected', 'Rejected')], default='draft', help_text='Current publication/approval status', max_length=50)),
                ('review_comments', models.TextField(blank=True, help_text='Admin comments for revision requests or rejections')),
                ('reviewed_at', models.DateTimeField(blank=True, help_text='When the project was reviewed by admin', null=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='non_infrastructure_projects_created', to=settings.AUTH_USER_MODEL)),
                ('reviewed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='non_infrastructure_projects_reviewed', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='non_infrastructure_projects_updated', to=settings.AUTH_USER_MODEL)),
            ],
            options={
