...
def non_infrastructure_public_data(revision):
    ...
    return {
        ...
        'project_type': noninfra.get('project_type') or 'EVENT',
        'project_type_label': noninfra.get('project_type_label') or 'Event / Activity',
        ...
        'target_beneficiaries': noninfra.get('target_beneficiaries') or '',
        'implementation_start_date': _date(noninfra.get('implementation_start_date')),
        'implementation_end_date': _date(noninfra.get('implementation_end_date')),
        ...
        'project_cost': _decimal(noninfra.get('project_cost')),
        'fund_source': noninfra.get('fund_source') or '',
        'contractor_supplier': noninfra.get('contractor_supplier') or '',
        'procurement_description': noninfra.get('procurement_description') or '',
        'quantity': noninfra.get('quantity'),
        'expected_delivery_date': _date(noninfra.get('expected_delivery_date')),
        'remarks': noninfra.get('remarks') or '',
        'report_date': (
            _date(noninfra.get('implementation_start_date'))
            or _date(noninfra.get('event_date'))
        ),
...
def non_infrastructure_dashboard_row(data):
    ...
    return {
        ...
        'office': data['proponent'], 'implementing_office': data['proponent'],
        'category_label': category.get('name') or '',
        ...
        'planned_start_date': data['implementation_start_date'] or data['event_date'], 'planned_end_date': data['implementation_end_date'],
