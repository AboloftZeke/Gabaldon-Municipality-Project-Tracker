...
class InfrastructureProject(models.Model):
    ...
    location = models.CharField(
        ...
        help_text="Select barangay location"
    )
    implementing_office = models.CharField(
        max_length=255,
        help_text="Office/Agency responsible for implementation"
    )
    ...
    award_status = models.CharField(
        ...
        default='ongoing_bidding'
    )
    source_of_fund = models.CharField(
        max_length=255,
        blank=True,
        help_text="e.g., 20% Development Fund"
    )
    abc_amount = models.DecimalField(
        max_digits=15,
        decimal_places=2,
        null=True,
        blank=True,
        verbose_name="Approved Budget for Contract (ABC)"
    )
    contract_price = models.DecimalField(
        ...
        null=True,
        blank=True,
        verbose_name="Contract Price / Bid Amount"
    )

    # Contract Adjustments
    variation_orders = models.TextField(
        blank=True,
        help_text="Record of variation orders with amounts, reasons, and approval dates"
    )

    # Disbursements
    disbursements_to_date = models.DecimalField(
        max_digits=15,
        decimal_places=2,
        null=True,
        blank=True,
        verbose_name="Total Disbursements/Payments to Date"
    )
    disbursement_details = models.TextField(
        blank=True,
        help_text="Breakdown by milestone or payment schedule"
    )
    ...
    revised_completion_date = models.DateField(
        null=True,
        blank=True,
        help_text="If there's extension of time"
    )

    # Progress Tracking
    cost_progress_percentage = models.DecimalField(
        max_digits=5,
        decimal_places=2,
        null=True,
        blank=True,
        verbose_name="Cost Progress (%)"
    )
    ...
    publication_status = models.CharField(
        ...
        default='draft',
        help_text="Current publication/approval status"
    )
    review_comments = models.TextField(
        blank=True,
        help_text="Admin comments for revision requests or rejections"
    )
    ...
    reviewed_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="When the project was reviewed by admin"
    )
